...
public class AddWechatAct extends BaseAct {
    ...
    private static final String IMAGE_FILE_NAME = "wechat.jpg";
    private static final String TMP_IMAGE_FILE_NAME = "tmp_wechat.jpg";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_wechat_act);
    ...
    private void modify() {
        ...
        String wechat = etAccount.getText().toString().trim();
        String passwd = etPassword.getText().toString().trim();

        if (file == null) {
            App.toast(this, "请上传微信二维码");
            return;
        }
        ...
        if (CUtils.isEmpty(wechat)) {
            App.toast(this, "微信账户不能为空");
            return;
        }
        ...
        if (!CUtils.isEmpty(PrefsManager.get().getString("userinfo"))) {
            ...
            App.toast(AddWechatAct.this, "请设置交易密码");
            return;
        }

        addWechat(wechat, file);
    }

    private void addWechat(String wechat, File file) {
        ...
        body.addFormDataPart("status", "1");
        body.addFormDataPart("wechat", wechat);
        ...
        service.bindingAlipay(body.build()).observeOn(AndroidSchedulers.mainThread()).subscribeOn(App.get().defaultSubscribeScheduler()).subscribe(new Action1<BaseResponse>() {
            ...
            public void call(BaseResponse baseResponse) {
                ...
                App.toast(AddWechatAct.this, baseResponse.message);
...
//                displayFrameworkBugMessageAndExit();
    ...
    private void instanceSelectWindow() {
        if (selectWindow == null) {
            View view = LayoutInflater.from(AddWechatAct.this).inflate(
            ...
            view.findViewById(R.id.btnLocalPhotos).setOnClickListener(
                    AddWechatAct.this);
            view.findViewById(R.id.btnCancele).setOnClickListener(AddWechatAct.this);
...
//                    modify(file);//后面打开
                    ...
                    Toast.makeText(AddWechatAct.this, "取消设置", Toast.LENGTH_SHORT)
                            .show();
                }
                break;
...
//                    modify(file);//后面打开
                    ...
                    Toast.makeText(AddWechatAct.this, "设置失败", Toast.LENGTH_SHORT)
                            .show();
                }
                // }
                break;
...
//        intent.putExtra("noFaceDetection", true);
    ...
    protected void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("AddWechatAct");
    ...
    protected void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("AddWechatAct");
