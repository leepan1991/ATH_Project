...
//            R.drawable.main_account_not_select};
    private int[] mBgArray = {R.drawable.tab_main_logo,
            R.drawable.tab_trade_logo,
            R.drawable.tab_coin_logo, R.drawable.tab_mine_logo};
    private String[] mTextviewArray;
    private Class[] fragmentArray = {MainFrag.class,
...
//    public static int tag = 7;
    ...
    private void initView() {
        ...
        mTabHost.setup(MainAct.this, getSupportFragmentManager(), R.id.content);
