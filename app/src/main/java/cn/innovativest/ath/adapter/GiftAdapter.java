...
public class GiftAdapter extends BaseAdapter {
    ...
    public GiftAdapter(Context context, List<Gift> listGifts) {
        this.context = context;
        this.listGifts = listGifts;
    }

    public void onRefresh(List<Gift> listGifts) {
        this.listGifts = listGifts;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvwInfo.setText("达到" + gift.count + "人数，领取" + gift.val + "积分");
        if (gift.state.equals("0")) {//已领取
            ...
            holder.btnGet.setBackgroundResource(R.drawable.gift_get);
